...
public class Response {
    ...
    /**
     * client side timeout. 客户端超时
     */
    public static final byte CLIENT_TIMEOUT = 30;

    /**
     * server side timeout. 服务端超时
     */
    public static final byte SERVER_TIMEOUT = 31;

    /**
     * channel inactive, directly return the unfinished requests.  通道不活动，直接返回未完成的请求
     */
    public static final byte CHANNEL_INACTIVE = 35;

    /**
     * request format error. request格式化错误
     */
    public static final byte BAD_REQUEST = 40;

    /**
     * response format error. response 格式化错误
     */
    ...
    /**
     * internal server error. 客户端错误
     */
    public static final byte CLIENT_ERROR = 90;

    /**
     * server side threadpool exhausted and quick return. 服务器端线程池耗尽，快速返回。
     */
