...
public class UrlUtils {
    ...
    /**
     * 判断消费URL和生产URL是否是能匹配上，判断 服务名、服务分类、enable、group、version、classifier几个纬度
     * @param consumerUrl 消费URL
     * @param providerUrl 服务URL
     * @return boolean
     */
